import {
  VariableDeclaration, Identifier, ArrayExpression, SimpleLiteral,
  SimpleCallExpression, Program, VariableDeclarator
} from 'estree'
...
export type YukiDeclaration = YukiConstDeclaration | YukiLetDeclaration
