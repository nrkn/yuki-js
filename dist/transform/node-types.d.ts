import { ExpressionStatement, Program, AssignmentExpression, Identifier, MemberExpression, Literal, CallExpression, UpdateExpression, BinaryExpression, LogicalExpression, SequenceExpression, UnaryExpression, ConditionalExpression, ForStatement, BlockStatement, WhileStatement, IfStatement, BreakStatement, ContinueStatement, DoWhileStatement, FunctionDeclaration, ReturnStatement, SimpleLiteral, VariableDeclaration, VariableDeclarator, ArrayExpression, SimpleCallExpression, AssignmentPattern, RestElement, EmptyStatement } from 'estree';
export declare type YukiNode = Program | ExpressionStatement | AssignmentExpression | Identifier | MemberExpression | Literal | CallExpression | UpdateExpression | BinaryExpression | LogicalExpression | SequenceExpression | UnaryExpression | ConditionalExpression | ForStatement | BlockStatement | WhileStatement | IfStatement | BreakStatement | WhileStatement | IfStatement | BreakStatement | ContinueStatement | DoWhileStatement | FunctionDeclaration | ReturnStatement | ArrayExpression | VariableDeclaration | VariableDeclarator | AssignmentPattern | RestElement | EmptyStatement;
...
export declare type YukiUnaryOperator = "-" | "+" | "!" | "~";
...
export declare const yukiUnaryOperators: string[];
